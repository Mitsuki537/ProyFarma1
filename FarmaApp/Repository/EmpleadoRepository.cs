...
{
    public class EmpleadoRepository<T> : IRepository<T> where T : class
    {
        private readonly HttpClient _httpClient;
        private readonly string _endpoint;

        public EmpleadoRepository(HttpClient httpClient, string endpoint)
        {
        ...
        public async Task<int> CreateAsync(object dto)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var createdEntity = JsonConvert.DeserializeObject<EmpleadoDto>(result);

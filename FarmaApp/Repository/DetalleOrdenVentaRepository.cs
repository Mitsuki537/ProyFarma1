...
{
    public class DetalleOrdenVentaRepository<T> : IRepository<T> where T : class
    {
        private readonly HttpClient _httpClient;
        private readonly string _endpoint;

        public DetalleOrdenVentaRepository(HttpClient httpClient, string endpoint)
        {
        ...
        public async Task<int> CreateAsync(object dto)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (createdEntity is DetalleOrdenVentaDto detalleOrdenVenta)
                {
                    return detalleOrdenVenta.IdSalesOrderDetail;
                }

                throw new InvalidCastException("El tipo deserializado no es DetalleOrdenVentaDto.");
            }

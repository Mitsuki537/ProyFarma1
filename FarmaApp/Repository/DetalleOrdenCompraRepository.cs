...
{
    public class DetalleOrdenCompraRepository<T> : IRepository<T> where T : class
    {
        private readonly HttpClient _httpClient;
        private readonly string _endpoint;

        public DetalleOrdenCompraRepository(HttpClient httpClient, string endpoint)
        {
        ...
        public async Task<int> CreateAsync(object dto)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (createdEntity is DetalleOrdenCompraDto detalleOrdenCompra)
                {
                    return detalleOrdenCompra.IdPurchaseOrderDetail;
                }

                throw new InvalidCastException("El tipo deserializado no es DetalleOrdenCompraDto.");
            }
